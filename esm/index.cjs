...
var ProxyToWorker = class {
  ...
  writeFile(fileName, blob) {
    return __async(this, null, function* () {
      const id = yield this.fileAlloc(fileName, blob.size);
      yield this.fileWrite(id, blob);
    });
  }
  /**
...
var Wllama = class {
   ...
   */
  loadLoraAdapter(_0) {
    return __async(this, arguments, function* (source, config = {}) {
      var _a;
      this.checkModelLoaded();
      ...
      yield this.proxy.writeFile(fileName, blob);
      const result = yield this.proxy.wllamaAction(
        "lora_load",
        {
          _name: "llod_req",
          lora_path: fileName,
          scale: (_a = config.scale) != null ? _a : 1
        }
      );
      if (!result.success) {
   ...
   * @returns Adapter ID
   */
  loadLoraAdapterFromHF(_0, _1) {
    return __async(this, arguments, function* (repoId, filePath, config = {}) {
